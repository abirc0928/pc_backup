        ...
        <div className={styles.Logo}>
            ...
            <div className={styles.glasses}>
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.63 42.68">
                    <g>
                        <g>
                            <rect className={`${styles.coloredLine} border`}
            ...
            <div className={styles.play}>
                <button  onClick={()=>setGlassColor(pickColorRandomly())} type="button">
                    Colorize Glass
                </button>
                <button onClick={()=>setGlassColor('black')} type="button">
                    Reset Glass
                </button>
            </div>
        </div>
